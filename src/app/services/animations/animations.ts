...
export const blurTransformAnimation = trigger('routeAnimations', [
    transition('* <=> *', [
        ...
        // false }),
        group([
            query(':leave', [animate('200ms linear', style({
                filter: 'blur(20px)',
                opacity: 0.8
            }))], { optional: true }),
            query(':enter', [animate('200ms linear', style({
                filter: 'blur(20px)',
                opacity: 0.3
            }))], { optional: true }),
        ]),
        group([
            query(':leave', [animate('100ms linear', style({
                filter: 'blur(30px)',
                opacity: 0.7
            }))], { optional: true }),
            query(':enter', [animate('100ms linear', style({
                filter: 'blur(30px)',
                opacity: 0.6
            }))], { optional: true }),
        ]),
        ...
        group([
            query(':leave', [animate('100ms ease-in-out', style({
                filter: 'blur(0)',
                opacity: 0
            }))], { optional: true }),
            query(':enter', [animate('100ms ease-in-out', style({
                filter: 'blur(0)',
                opacity: 1
            }))], { optional: true }),
        ]),
